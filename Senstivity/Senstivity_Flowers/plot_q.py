...
for model in [ 'efficientformer_l1', 'resnet18']:
# for model in ['densenet121', 'resnet18']:
    # plt = plot_config()
    plt.figure()
    ...
    # Y_sens = ((Y_sens - min_Y)/(max_Y-min_Y)) * (10 - 1) + 1
    # CbCr_sens = ((CbCr_sens - min_Y)/(max_Y-min_Y)) * (10 - 1) + 1
