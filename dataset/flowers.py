...
if __name__ == '__main__':
    train_dataset = Flowers('./data/flowers/flowers-102', train=True, download=True)
    test_dataset = Flowers('./data/flowers/flowers-102', train=False, download=False)

# if __name__ == '__main__':
#     train_dataset = Flowers102('./data/flowers', split="train", download=True)
#     test_dataset = Flowers102('./data/flowers', split="val", download=False)