...
def load_dataset(name, batch_size=32, num_workers=8, mean=(0.485, 0.456, 0.406), std=(0.229, 0.224, 0.225), root='', **kwargs):
    ...
    if name in ['ImageNet','tinyimagenet', 'CUB200', 'STANFORD120', 'MIT67']:
        ...
        if name == 'tinyimagenet':
            ...
            train_set = Cub2011('./data/dogs', transform=transform_train, train=True, download=True)
            val_set  = Cub2011('./data/dogs', transform=transform_test, train=False, download=True)
