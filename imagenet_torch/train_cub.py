...
def main(args):
    ...
    data_loader, data_loader_test = load_dataset(name="CUB200", mean=[0.485, 0.456, 0.406], std=[0.229, 0.224, 0.225], batch_size=args.batch_size)
    num_classes = len(data_loader.dataset)
...
def get_args_parser(add_help=True):
    ...
    parser.add_argument("--data-path", default="/home/l44ye/datasets/", type=str, help="dataset path")
