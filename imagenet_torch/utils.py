...
def load_model_imagenet(Model, pretrained=False, **kwargs):
    ...
    if Model=="resnet18":
        ...
        pretrained_model = models.squeezenet1_1(pretrained=pretrained)

    elif Model == 'Shufflenetv2_05':
        pretrained_model = models.shufflenet_v2_x0_5(pretrained=pretrained)
    elif Model == 'Shufflenetv2_10':
        pretrained_model = models.shufflenet_v2_x1_0(pretrained=pretrained)
    elif Model == 'Shufflenetv2_15':
        pretrained_model = models.shufflenet_v2_x1_5(pretrained=pretrained)
    elif Model == 'Shufflenetv2_20':
        pretrained_model = models.shufflenet_v2_x2_0(pretrained=pretrained)
        ...
        pretrained_model = models.mnasnet0_5(pretrained=pretrained)

    elif Model == 'Alexnet':
        weights= models.AlexNet_Weights.DEFAULT
        pretrained_model = models.alexnet(pretrained=pretrained)
    
    elif Model == 'ConvNeXt_base':
        weights = models.ConvNeXt_Base_Weights.IMAGENET1K_V1
        pretrained_model = models.convnext_base(pretrained=pretrained)
    elif Model == 'ConvNeXt_tiny':
        weights = models.ConvNeXt_Tiny_Weights.IMAGENET1K_V1
        pretrained_model = models.convnext_tiny(pretrained=pretrained)
    elif Model == 'ConvNeXt_large':
        weights = models.ConvNeXt_Large_Weights.IMAGENET1K_V1
        pretrained_model = models.convnext_large(pretrained=pretrained)
        ...
        pretrained_model = models.wide_resnet101_2(pretrained=pretrained)
        ...
        pretrained_model = models.wide_resnet50_2(pretrained=pretrained)
        ...
        pretrained_model = models.efficientnet_b0(pretrained=pretrained)
